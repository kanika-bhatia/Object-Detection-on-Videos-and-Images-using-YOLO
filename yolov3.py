...
parser.add_argument('--video_path', help="Path of video file", default="TrafficVideo_edited.mp4")
parser.add_argument('--image_path', help="Path of image to detect objects", default="soccer.jpg")
